    ...
    <div className="shop-page-replica" style={{ position: 'relative', minHeight: '100vh', background: '#000000' }}>
      ...
      <div className="product-showcase-section" style={{ 
        ...
        >
          ...
          {/* Product Card 5 - CMF Phone 1 (ORANGE) */}
          <div
            className="product-card"
            data-testid="product-card-cmf-phone1-orange"
            style={{
              background: 'transparent',
              textAlign: 'center',
              cursor: 'pointer',
          ...
          >
            <div style={{
              ...
              <img
                src="/CMFPhone1Orange.png"
                alt="CMF Phone 1 Orange"
                style={{
                  width: '80%',
                  height: '80%',
                  objectFit: 'contain',
          ...
          {/* Product Card 6 - CMF Phone 2 Pro (BLACK) */}
          <div
            className="product-card"
            data-testid="product-card-cmf-phone2-black"
            style={{
              background: 'transparent',
              textAlign: 'center',
              cursor: 'pointer',
          ...
          {/* Product Card 7 - CMF Phone 2 Pro (ORANGE) */}
          <div
            className="product-card"
            data-testid="product-card-cmf-phone2-orange"
            style={{
              background: 'transparent',
              textAlign: 'center',
              cursor: 'pointer',
          ...
          {/* Product Card 8 - CMF Phone 2 Pro (WHITE) */}
          <div
            className="product-card"
            data-testid="product-card-cmf-phone2-white"
            style={{
              background: 'transparent',
              textAlign: 'center',
              cursor: 'pointer',
